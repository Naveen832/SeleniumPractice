...
//        // For example, you might use driver.findElement(By.implemented on the webpage.
   }id("cookie-accept-button")).click();
//        // You need to adapt this step based on how the cookie consent is 
//    public static void acceptCookies12(WebDriver driver, String url1) {
//    	driver.get(url1);
//        WebElement acceptCookiesButton = driver.findElement(By.xpath("//button[@id='ensAcceptAll']"));
//        acceptCookiesButton.click();
//    }
//    public static void acceptCookies13(WebDriver driver, String url2) {
//    driver.get(url2);
//        WebElement acceptCookiesButton = driver.findElement(By.xpath("//button[@id='ensAcceptAll']"));
//        acceptCookiesButton.click();
